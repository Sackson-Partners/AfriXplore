...
var services = [
  ...
  { name: 'msim-api',           image: 'placeholder',   port: 3004, minReplicas: 1, maxReplicas: 5,  cpu: '0.25', memory: '0.5Gi' }
  { name: 'notification',       image: 'placeholder',   port: 3002, minReplicas: 1, maxReplicas: 5,  cpu: '0.25', memory: '0.5Gi' }
  { name: 'payment',            image: 'placeholder',   port: 3003, minReplicas: 1, maxReplicas: 5,  cpu: '0.25', memory: '0.5Gi' }
